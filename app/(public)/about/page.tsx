  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-14 text-center">
        ...
        <h1 className="mb-3 text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
      ...
      <div className="mb-12 sm:mb-16 grid gap-4 sm:gap-6 sm:grid-cols-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-5 sm:p-6 shadow-sm hover:shadow-md transition">
          ...
          <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-bold text-gray-900">Misi Kami</h3>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 sm:p-6 shadow-sm hover:shadow-md transition">
          ...
          <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-bold text-gray-900">Digerakkan Komunitas</h3>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 sm:p-6 shadow-sm hover:shadow-md transition">
          ...
          <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-bold text-gray-900">Direct Download & CDN</h3>
          <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5 sm:p-6 shadow-sm hover:shadow-md transition">
          ...
          <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-bold text-gray-900">Gratis Selamanya</h3>
          <p className="text-sm text-gray-600 leading-relaxed">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-store/30 bg-gradient-to-b from-store/10 via-white to-store/5 p-5 sm:p-10 text-center shadow-xl">
        ...
        <h2 className="mb-3 text-xl sm:text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">
          Donasi Pengembangan <span className="text-store">Mobix</span>
        </h2>
        <p className="mx-auto mb-6 sm:mb-8 max-w-xl text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        {/* QRIS Card Box */}
        <div className="mx-auto w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 shadow-lg">
          <div className="mb-3 flex items-center justify-center gap-1.5 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-gray-500 border-b border-gray-100 pb-2.5">
            <QrCode className="size-3.5 sm:size-4 text-store shrink-0" />
            <span>QRIS Resmi Donasi Mobix</span>
          </div>

          <div className="relative mx-auto my-3 w-full max-w-[200px] sm:max-w-[280px] aspect-[4/5] overflow-hidden rounded-xl border border-gray-100 bg-white shadow-inner flex items-center justify-center p-2">
            <Image
              src="/assets/qris.png"
          ...
          <p className="mt-3 text-[10px] sm:text-[11px] font-semibold text-gray-400 leading-relaxed">
            *Dapat dipindai/scan menggunakan semua aplikasi e-Wallet (GoPay, OVO, DANA, ShopeePay) & Mobile Banking.
          </p>
        </div>

        <div className="mt-6 sm:mt-8 flex items-center justify-center gap-2 text-xs font-bold text-gray-500">
